		...
		<React.Fragment>
			<div className="container mt-5">
				<form>
					...
					<br></br>
					<button id="save-btn" className="btn btn-success m-2" type="button" onClick={() => updateStatus(applications._id)}>
						Save
					</button>
					<button id="delete-btn" className="btn btn-danger m-2" type="button" onClick={() => deleteApplication(applications._id)}>
						Delete
					</button>
				</form>
			</div>
